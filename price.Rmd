...
If you haven't climbed before then the best option is to purchase WUCC membership with the club pass. That way you can learn to top-rope and lead climb through WUCC, as well as determine whether you like climbing enough to purchase the Wall Membership. 

If you already know how to climb and want to go on trips then things are slightly more complicated. WUCC do a few trips per term, as well as a tour in Term 3. The trips cost between £50 and £60 and tour typically costs around £X. WUCU do more trips per term and the cost per trip is much cheaper. If you already know how to climb and don't want to specifically go on WUCC trips or tour then you could save £100 by joining WUCU instead of WUUC. 
