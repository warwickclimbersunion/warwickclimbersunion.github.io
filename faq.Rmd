...
WUCU is a British Mountaineering Council (BMC) affiliated club, this affiliation costs £16.75 per member and provides us with [combined liability insurance](http://www.bmc-insurance-centre.co.uk/uploads/documents/bmc-insurance-centre//BMC-Club-Summary-2020-June-2020.pdf){target="_blank"}. There is a further £3.25 cost to join, which is to help the club’s cash flow. If you have also joined WUCC and paid the BMC fee, you can [have one of them refunded by the BMC](https://www.thebmc.co.uk/claiming-multiple-membership-refunds){target="_blank"}.
